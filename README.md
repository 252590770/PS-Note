 ...
 * 画笔的面板参数设置
	...
	* 画笔面板
		...
		![画笔面板](/img/画笔面板.png){:height="100" width="100"}
	
	* 间距

		![jianju](/img/jianju.png){:height="100" width="100"}

	* 颜色动态

		![颜色动态](/img/颜色动态.png){:height="100" width="100"}

	* 叠加透明度

		![叠加透明度](/img/叠加透明度.png){:height="100" width="100"}

		<img src="/img/叠加透明度.png" width="100" >
